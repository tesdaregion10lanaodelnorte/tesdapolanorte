            ...
            <div class="row">
                <div class="col-sm-8 col-md-4 col-lg-4">
                    <div class="single_footer_part">
                        <a href="index.html" class="footer_logo_iner"> <img src="img/tesdalogo/logo.png" alt="#"> </a>
...
&copy;<script>document.write(new Date().getFullYear());</script> Developed By: | TESDA Lanao del Norte Provincial Office</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></P>
                ...
                <div class="col-lg-4">
                    <div class="footer_icon social_icon">
                        <ul class="list-unstyled">
                            <li><a href="https://www.facebook.com/TesdaOnline/" class="single_social_icon"><i class="fab fa-facebook-f"></i></a></li>
